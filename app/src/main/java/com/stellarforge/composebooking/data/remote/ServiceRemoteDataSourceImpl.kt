...
class ServiceRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun addService(service: Service): Result<Unit> {
        return try {
            ...
            Result.Success(Unit)
        } catch (e: Exception) { Result.Error(e, "Servis eklenemedi.") }
    }
    ...
    override suspend fun updateService(service: Service): Result<Unit> {
        return try {
            ...
            Result.Success(Unit)
        } catch (e: Exception) { Result.Error(e, "Servis güncellenemedi.") }
    }
    ...
    override suspend fun deleteService(serviceId: String): Result<Unit> {
        return try {
            ...
            Result.Success(Unit)
        } catch (e: Exception) { Result.Error(e, "Servis silinemedi.") }
    }
